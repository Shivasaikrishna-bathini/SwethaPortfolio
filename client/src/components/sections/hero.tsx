...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative px-6 py-[6.854rem]">
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          <div className="mb-6 inline-block">
            <span className="px-4 py-2 rounded-full glass text-sm font-mono text-primary">
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-[2.618rem]">
        ...
        >
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Building scalable AI-driven applications with expertise in <span className="text-primary">Agentic AI</span>, 
            <span className="text-secondary"> Multi-Agent Systems</span>, and <span className="text-accent">RAG Pipelines</span>
          </p>
        </FadeIn>
        ...
        >
          <div className="flex gap-6 justify-center">
            {/* TODO: UPDATE YOUR GITHUB - Change the URL below to your GitHub profile */}
            <a 
              href="https://github.com/Saisriswetha" 
              target="_blank" 
